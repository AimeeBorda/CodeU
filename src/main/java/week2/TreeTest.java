...
public class TreeTest {
  ...
  public void testPrintAncestorSimple() {
    assertEquals("prints empty string for root", "", tree.printAncestors(simpleTree, 7));
    assertEquals("prints \"8, 7\" for ancestor on LHS (5)", "8, 7",
        tree.printAncestors(simpleTree, 5));
    assertEquals("prints \"7\" for ancestor on RHS (6)", "7", tree.printAncestors(simpleTree, 6));
  ...
  public void testPrintAncestorExample() {
    assertEquals("prints \"3, 9, 16\"", "3, 9, 16", tree.printAncestors(exampleTree, 5));
  }

  @Test
  public void testCommonAncestorEmpty() {
    assertNull("should return null for empty tree", tree.commonAncestor(emptyTree, 1, 2));
  }
  ...
  public void testCommonAncestorSimple() {
    assertEquals("should return 8 for (10,5)", 8, (int) tree.commonAncestor(simpleTree, 10, 5));
    assertEquals("should return 8 for (5,10)", 8, (int) tree.commonAncestor(simpleTree, 5, 10));
    assertEquals("should return 7 for (6,10)", 7, (int) tree.commonAncestor(simpleTree, 6, 10));
  }
  ...
  public void testCommonAncestorExample() {
    ...
    assertNull("should return null for (15,5)", tree.commonAncestor(exampleTree, 15, 6));
  }
